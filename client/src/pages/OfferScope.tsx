...
const included = [
  ...
  "One high-ticket conversion infrastructure",
  "Catering, Event Venue & Premium Dining inquiry flows",
  "CRM integration & Corporate lead routing", "Owner/team instant notifications", "Corporate confirmation sequences",
  "Lead recovery foundation", "Automated follow-up pipelines", "Stripe payment infrastructure",
